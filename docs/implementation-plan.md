...
- Updated `README.md` to document:
  - `go install github.com/wolf-jonathan/workspace-x@latest` as the default cross-platform install path
...
- The first supported global install path is `go install github.com/wolf-jonathan/workspace-x@latest`; package-manager support remains a later distribution phase.
